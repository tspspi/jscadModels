/*
    ...
    SM05T2 to allow easy design of mechanical assemblies
...
window.jscad.tspi.physics.thorlabs.SM05T2 = function(printer, params) {
    this.getTemplate = function() {
        return difference(
            cylinder({ d : 13.589, h : 12.7, center : true }),
            cylinder({ d : 11.4, h : 12.7, center : true})
        );
    }
...
function main() {
    let part = new window.jscad.tspi.physics.thorlabs.SM05T2({},{});
